...
let IdentificationType = class IdentificationType {
};
...
], IdentificationType.prototype, "code", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], IdentificationType.prototype, "description", void 0);
exports.IdentificationType = IdentificationType = __decorate([
    (0, typeorm_1.Entity)('daf_tipos_identificacion')
], IdentificationType);
